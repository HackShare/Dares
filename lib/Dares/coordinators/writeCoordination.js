...
WriteCoordination.prototype._vote = function () {
    if ( this.coordination.state.name !== 'beginWrite' ) {
        throw new Error( 'Wrong state, expected "beginWrite" but got ' + this.coordination.state.name );
    }
...
WriteCoordination.prototype._prepareCommit = function () {
    if ( this.coordination.state.name !== 'waitForVotes' ) {
        throw new Error( 'Wrong state, expected "waitForVotes" but got ' + this.coordination.state.name );
    }
